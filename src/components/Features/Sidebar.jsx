...
export default function Sidebar() {
  ...
  return (
    <Navbar className="animate__animated animate__zoomIn">
      ...
      <NavbarGif>
        <Link to="/AboutMe">
          <FontAwesomeIcon icon={faUser} color={colorOcean} />
        </Link>
        <DivTest class="tooltip">
          <span>About Me</span>
        </DivTest>
      ...
      <NavbarGif>
        <Link to="/Resume">
          <FontAwesomeIcon icon={faGraduationCap} color={colorOcean} />
        </Link>
        <DivTest class="tooltip">
          <span>Resume</span>
        </DivTest>
      ...
      <NavbarGif>
        <Link to="/Projects">
          <FontAwesomeIcon icon={faProjectDiagram} color={colorOcean} />
        </Link>
        <DivTest class="tooltip">
          <span>Projects</span>
        </DivTest>
      ...
      <NavbarGif>
        <Link to="/Contact">
          <FontAwesomeIcon icon={faEnvelope} color={colorOcean} />
        </Link>
        <DivTest class="tooltip">
