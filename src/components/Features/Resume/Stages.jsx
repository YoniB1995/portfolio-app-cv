	...
	return (
		<Timeline align="alternate">
			<TimelineItem className="timeLine" >
				...
				<Paper elevation={3} style={paperstyle}><b>2007-2013</b><br /> High School Matriculation Certificate - Geography and Oral Law
				</Paper>
				</TimelineContent>
			</TimelineItem>
			<TimelineItem className="timeLine">
				...
				<Paper elevation={3} style={paperstyle}><b>2014-2020</b> <br /> Officer at Combat Regiment "Kfir" and "Bardelas".
			...
			<TimelineItem className="timeLine">
				...
				<TimelineContent >
				<Paper elevation={3}
					style={paperstyle}><b>2020.12 - 2021.10 </b><br /> Student at Tech-Career Academy center . Learning Full-Stack Web-Development includes Frontend & Backend Platforms.
				</Paper>
				</TimelineContent>
			</TimelineItem>
			<TimelineItem className="timeLine">
